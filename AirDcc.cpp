...
// Function to set up and start the modem in rx or tx.
// Set transmit to 1 for transmit, anything else for receive.
...
// Function to periodically remind the modem to tx or rx.
